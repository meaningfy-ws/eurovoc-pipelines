...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="moduleReference" select="'test'"/>
    <!--    rdfs:label -->
...
<xsl:variable name="ontologyLabelShapes" select="'Core Public Organisation Vocabulary - core shapes'"/>
    ...
    <xsl:variable name="incompatibleWith" select="'3.3.0'"/>
    <!--    owl:versionInfo -->
    <xsl:variable name="versionInfo" select="'4.3.0'"/>
    <!--    bibo:status-->
    <xsl:variable name="ontologyStatus" select="'Semantic Specification Release'"/>
    <!--    owl:priorVersion -->
    <xsl:variable name="priorVersion" select="'3.3.0'"/>
